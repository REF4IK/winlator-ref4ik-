...
public abstract class WineUtils {
    ...
    public static void ensureSteamappsCommonSymlink(Container container, String gameDirectoryPath) {
        ...
        if (!steamCommonDir.exists()) steamCommonDir.mkdirs();
        ...
        if (!steamworksSharedDir.exists()) steamworksSharedDir.mkdirs();
        File steamworksCommonRedist = new File(steamworksSharedDir, "_CommonRedist");
        if (!steamworksCommonRedist.exists()) steamworksCommonRedist.mkdirs();
