...
public class Container {
    ...
    public static final String DEFAULT_GRAPHICSDRIVERCONFIG = "version=" + DefaultVersion.WRAPPER + ";blacklistedExtensions=" + ";maxDeviceMemory=0" + ";adrenotoolsTurnip=1" + ";frameSync=Normal" + ";presentMode=mailbox" + ";resourceType=auto" + ";bcnEmulation=auto" + ";bcnEmulationType=compute" + ";bcnEmulationCache=0" + ";blit=0" + ";vulkanVersion=1.3";
    ...
    public static final String DEFAULT_DRIVES = "D:/storage/emulated/0/E:/data/data/com.winlator.cmod/storage";
