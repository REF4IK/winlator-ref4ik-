...
public class ContainersFragment extends Fragment {
    ...
    private class ContainersAdapter extends RecyclerView.Adapter<ContainersAdapter.ViewHolder> {
        ...
        private class ViewHolder extends RecyclerView.ViewHolder {
            private final View runButton; // MaterialButton in new layout
            private final View menuButton; // MaterialButton in new layout
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            String wineVersionText = item.getWineVersion();
            ...
            listItemMenu.setOnMenuItemClickListener((menuItem) -> {
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.container_info:
                        ...
                        break;
                    case R.id.container_file_manager:
                        openContainerFileManager(container);
                        break;
        ...
        private void openContainerFileManager(Container container) {
            if (container.getRootDir() == null || !container.getRootDir().isDirectory()) {
                AppUtils.showToast(getContext(), R.string.container_file_manager_unavailable);
                return;
            }

            Intent intent = new Intent(getContext(), FileManagerActivity.class);
            intent.putExtra(FileManagerActivity.EXTRA_TITLE, getString(R.string.container_file_manager));
            intent.putExtra(FileManagerActivity.EXTRA_CONTAINER_ID, container.id);
