...
public class ContentDialog extends Dialog {
    ...
    public ContentDialog(@NonNull Context context, int layoutResId, boolean forceDarkMode) {
        super(context, forceDarkMode || shouldUseDarkDialog(context) ? R.style.ContentDialog_Dark : R.style.ContentDialog);
...
//        contentView.setBackgroundResource(isDarkMode ? R.drawable.content_dialog_background_dark: R.drawable.content_dialog_background);
    ...
    public static boolean shouldUseDarkDialog(Context context) {
        ...
        if (context.getTheme().resolveAttribute(android.R.attr.windowBackground, value, true)) {
            return value.resourceId == R.drawable.content_dialog_background_dark;
        }
        return false;
    }
