 ...
 *
 * Robust Contrast Adaptive Sharpening. Adds adaptive sharpness to the EASU
 * upscaled image. Sharpness is expressed in stops: 0.0 = max sharp, 2.0 = soft.
 *
...
public class FSR1RcasEffect extends Effect {
    private float sharpnessStops = 0.25f;
